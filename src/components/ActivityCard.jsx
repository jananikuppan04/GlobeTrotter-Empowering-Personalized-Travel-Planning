...
export default function ActivityCard({ activity, onAddToItinerary }) {
  ...
  return (
    <div className="glass-card rounded-2xl overflow-hidden group flex flex-col justify-between border border-gray-800/80 hover:border-indigo-500/40 transition-all duration-300">
      ...
      <div className="relative h-40 w-full overflow-hidden bg-gray-900">
        ...
        <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-xs text-gray-200">
          <div className="flex items-center gap-1.5 bg-gray-900/80 backdrop-blur-md px-2 py-0.5 rounded-lg border border-gray-700">
      ...
      <div className="p-4 space-y-3 flex-1 flex flex-col justify-between">
        ...
        <div className="pt-3 border-t border-gray-800/80 flex items-center justify-between">
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl text-xs font-bold text-white bg-gray-800 hover:bg-indigo-600 border border-gray-700 hover:border-indigo-500 transition-all shadow-sm"
          >
